...
public class Biblio {
    ...
    private static final String pass="79161527";
    private static final String url="jdbc:mysql://localhost:3307/biblioteca?characterEncoding=utf8";
    // Funcion que va conectarse a la base de datos de mysql
